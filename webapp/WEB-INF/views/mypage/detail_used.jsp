...
<!-- fontawesome -->
<script src="https://kit.fontawesome.com/d80d4fed4a.js"
						...
						<section>
							...
							<div>
								...
								<p class="inp_wrap remove form-errors">
									<input type="text" name="review_title" class="review_section"
							...
							<div>
								<input class="fileUpload" type="file" id="review_file" multiple>
							</div>
						</section>
						<div class="pw_input__btns-wrap modifying">
							<button class="btns-wrap__submit-btn" type="submit">리뷰등록</button>
						</div>
						<!---->
				</div>
			</div>
