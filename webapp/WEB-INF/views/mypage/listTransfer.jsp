				...
				<div class="reserve_list">
					<section class="list_cancel">
						...
						<c:choose>
								...
								<c:forEach var="list" items="${list}">
									<ul class="list_wrap">
										<li class="reservation-detail"><div>
												...
												<a href="${pageContext.request.contextPath}/my/detail?resNo=${list.resNo}" class="product-title"><i class="bg_w">양도완료</i> <strong>${list.pName}</strong>
							...
							<c:otherwise>
								<div class="list_none" style="display: block;">양도완료 내역이 없습니다.</div>
							</c:otherwise>
						</c:choose>
					</section>
				</div>
