								...
								<c:forEach items="${list}" var="list" varStatus="status">
									<ul class="list_wrap">
										<li class="reservation-detail"><div>
												<p class="pic">
													<img src="${pageContext.request.contextPath}/upload/${list.saveName}" alt="" class="align">
												</p>
												<a class="product-title" href="${pageContext.request.contextPath}/my/detail?resNo=${list.resNo}"><i>예약완료</i> <strong>${list.pName }</strong>
