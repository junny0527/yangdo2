...
<body class="pc and">
			...
			<div class="align_rt">
				<div class="reserve_detail">
					...
					<div class="info" style="">
						<div>
							<i>${myVo.status}</i> <strong>${myVo.pName}</strong> <span>${myVo.rName}(기준
					...
					<section>
						<div style="padding-top: 0; padding-bottom: 0">
							<div
								...
								<a href="${pageContext.request.contextPath}/sale?no=${param.no}">
									<button type="button"
	...
	<!-- 취소환불 프로세스 모달창 -->
	<div class="modal fade" id="reservationConfirm"
		data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="reservationConfirm" aria-hidden="true">
		<div
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row m-4" name="reason">
						...
						<ul>
							<li><small>취소수수료가 발생한 경우 포인트 -> 상품권 -> 현금 순으로 차감됩니다.
									실결제금액에서 현금에서 차감되는 취소수수료를 뺀 금액이 결제수단으로 환불 됩니다.</small></li>
							...
							<li><small>예약/결제 당시에 적용된 예약/결제 시 사용한 포인트는 포인트로, 상품권은
									해당 상품권의 잔액으로 복원됩니다. 단, 취소 수수료를 차감한 금액으로 복원될 수 있습니다. 포인트나 상품권
									잔액은 취소에 의한 복원 여부에 상관없이 원 유효기간 등에 따라 잔액이 소멸될 수 있으니 주의 바랍니다.</small></li>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="openCancelModal()">취소진행</button>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="modal-footer">
					<form action="/reservation/refund" id="reservationNoForm">
						...
						<a class="btn btn-danger" data-bs-toggle="modal"
							onclick="reservationNoSubmit()" role="button">확인</a> <input
							type="hidden" id="reservationNo" name="reservationNo"
							value="${payment.reservation.reservationNo }">
					</form>
				</div>
			</div>
		</div>
