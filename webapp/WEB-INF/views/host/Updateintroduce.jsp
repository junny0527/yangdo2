					...
					<table id="intro" class="table resize">
						...
						<tbody>
							...
							<tr>
								...
								<td id = "firstline" class="bd_r_none">
									<div class="form-layer mb_24">
										<span class="form-title">펜션명</span> <span class="form-body"> <input class="form-control normal-size" type="text" name="pensionName" placeholder="업체명을 입력하세요." value="${pMap.hVo.pensionName}">
										</span>
									</div>
									<div class="form-layer mb_24">
										...
										<span class="form-body">
											<input class="form-control normal-size" id="input_roadAddress" type="text" name="pensionAddress" readonly placeholder="업체 주소를 입력하세요." value="${pMap.hVo.pensionAddress}">
									...
									<div class="form-layer newline mb_24">
										<span class="form-body">
											<input id="address"class="form-control normal-size" type="text" name="detailAddress" placeholder="나머지 주소를 입력하세요." value="${pMap.hVo.detailAddress}">
										</span>
									</div>
									<div class="form-layer-text">
										...
										<div id = "legalname" class = "order">
											...
											<input id = "lawcode" type="text" name = "lawCode" readonly value = "${pMap.hVo.lawCode}">
											<input id = "fullname" type="text" name = "lawName" readonly value = "${pMap.hVo.lawName}">
										</div>
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="2">
									<div id = "visitpath" class="form-layer">
										<input type="text" class="form-control writeform" name="visitRoad1" placeholder="주요 버스터미널, 기차역 등에서 숙소를 찾아가는 방법을 간단히 기재해 주세요. 예시)대성리역 차량 10분" value="${pMap.hVo.visitRoad1}"> <br> 
										<input type="text" class="form-control writeform" name="visitRoad2" placeholder="주요 버스터미널, 기차역 등에서 숙소를 찾아가는 방법을 간단히 기재해 주세요. 예시)대성리역 차량 10분" value="${pMap.hVo.visitRoad2}"> <br> 
										<input type="text" class="form-control writeform" name="visitRoad3" placeholder="주요 버스터미널, 기차역 등에서 숙소를 찾아가는 방법을 간단히 기재해 주세요. 예시)대성리역 차량 10분" value="${pMap.hVo.visitRoad3}"> 
							...
							<tr>
								...
								<td colspan="2">
									...
									<div class="form-layer">
										<input type="text" class="form-control writeform" name="areaInfo1" placeholder="교통, 관광, 쇼핑 명소부터 게스트하우스까지의 소요시간을 작성해 주세요." value="${pMap.hVo.areaInfo1}"> <br> 
										<input type="text" class="form-control writeform" name="areaInfo2" placeholder="교통, 관광, 쇼핑 명소부터 게스트하우스까지의 소요시간을 작성해 주세요." value="${pMap.hVo.areaInfo2}"> <br> 
										<input type="text" class="form-control writeform" name="areaInfo3" placeholder="교통, 관광, 쇼핑 명소부터 게스트하우스까지의 소요시간을 작성해 주세요." value="${pMap.hVo.areaInfo3}">
									</div> <span class="exam-button"> <i class="fa fa-angle-up" aria-hidden="true"></i></span>
							...
							<tr>
								...
								<td colspan="2">
									<div class="form-layer">
										<textarea class="form-control textarea-layer" rows="6" name="rules" placeholder="숙소 내 필수 이용규칙이 있을 경우 기재해주세요.">${pMap.hVo.rules}</textarea>
									</div> <span class="exam-button"> <i class="fa fa-angle-up" aria-hidden="true"></i></span>
