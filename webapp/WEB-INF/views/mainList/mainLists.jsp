...
<body>
   ...
   <!-- wrap -->
      ...
      /* for(var i=0; i<addressArray.length; i++){
         var pName = addressName[i].groupName;
         // 주소로 좌표를 검색합니다
         geocoder.addressSearch(addressArray[i].groupAddress,function(data, status, pagination, pName) {
                  console.log(pName);
                   // 정상적으로 검색이 완료됐으면 
      ...
      function displayMarker(place) {
          var marker = new kakao.maps.Marker({
           ...
           var content = '<div style="width:150px;text-align:center;padding:6px 0;">'+ place.place_name   +'</div>'
