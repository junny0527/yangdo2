		...
		<section>
			<form id="loginForm" action="" autocomplete="off" method="post" novalidate="novalidate">
				...
				<button type="button" id="kakao-login-btn" class="btn_start btn_kakao" data-device-type="W">
					<span><img id="kakaoLogo" src="${pageContext.request.contextPath}/assets/image/users/kakao.png"></i>카카오톡으로 로그인</span>
				</button>
				<a
				...
				<div class="link_half">
					...
					<div>
						<a href="${pageContext.request.contextPath}/join/selectJoin"><span>회원가입</span></a>
					</div>
				</div>
			</form>
		</section>
